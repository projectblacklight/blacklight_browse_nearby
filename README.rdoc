...
An inclusion of BlacklightBrowseNearby::Controller
  
In a view under the show action of a controller that has included the BlacklightBrowseNearby::Controller you can use the render_nearby_items helper.
